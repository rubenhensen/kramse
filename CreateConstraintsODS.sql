...
ADD CONSTRAINT PK_Ship PRIMARY KEY CLUSTERED (Id);

ALTER TABLE [dbo].[Dim_Port]
ADD CONSTRAINT PK_Port PRIMARY KEY CLUSTERED (Id);
...
ADD CONSTRAINT PK_Container PRIMARY KEY CLUSTERED (Id);

ALTER TABLE [dbo].[Dim_Consignor]
ADD CONSTRAINT PK_Consignor PRIMARY KEY CLUSTERED (Id);
